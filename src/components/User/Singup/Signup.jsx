    ...
    <div className="max-w-md mx-auto mt-8 p-6 border rounded-md shadow-md">
        ...
        <form onSubmit={handleSubmit}>
            <div className="mb-4">
                ...
                <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-500" required />
            </div>
            <div className="mb-4">
